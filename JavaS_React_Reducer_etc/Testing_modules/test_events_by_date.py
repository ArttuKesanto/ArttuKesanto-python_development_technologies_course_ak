...
def test_swap_changes_positions_two_strings():
	my_list = ['a', 'b', 'c']

	swap(my_list, 0,2)
	assert my_list == ['c', 'b', 'a']
def test_this_will_success():
	num = 10
	assert num > 3
...
def test_swap_changes_position_of_events():
