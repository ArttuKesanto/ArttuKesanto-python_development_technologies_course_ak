...
class DIPConfigurator {
    ...
    public static BusinessLuokka konfiguraatioAutolle() {
        ...
        Ajoneuvo ajoneuvo = new Auto(56000, 2018, true);
        businessLuokkaAutolle.setAjoneuvo(ajoneuvo);
    ...
    public static BusinessLuokka konfiguraatioMoottoripyorille() {
        ...
        Ajoneuvo ajoneuvo = new Moottoripyora(20500, 2015, false);
        businessLuokkaMoottoripyoralle.setAjoneuvo(ajoneuvo);
        //System.out.println(businessLuokkaMoottoripyoralle);
        return businessLuokkaMoottoripyoralle;
    }
}

/**
 * Ajoneuvo-rajapinta, muiden "alaluokkien" pitää vähintään toteuttaa nämä jutut.
 */
interface Ajoneuvo {
 ...
 */
class BusinessLuokka { // If you inherit classes, use extends?
    /**
     ...
     */
     ...
     //Ajoneuvo auto = new Auto(56000, 2018, true);
     //Ajoneuvo moottoripyörä = new Moottoripyora(20500, 2015, false);
    /**
